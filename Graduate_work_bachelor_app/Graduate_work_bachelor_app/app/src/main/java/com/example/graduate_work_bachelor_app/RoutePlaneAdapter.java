...
public class RoutePlaneAdapter extends BaseAdapter {

    private List<AirplaneRoute> routes;
    private LayoutInflater inflater;
    private Context context;

    public RoutePlaneAdapter(Context context, List<AirplaneRoute> routes) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final AirplaneRoute route = routes.get(position);
        ...
        holder.departureStation.setText(route.getDepartureAirport());
        holder.arrivalStation.setText(route.getArrivalAirport());
