...
public class RouteTrainAdapter extends BaseAdapter {

    private List<TrainRoute> routes;
    private LayoutInflater inflater;
    private Context context;

    public RouteTrainAdapter(Context context, List<TrainRoute> routes) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final TrainRoute route = routes.get(position);
        ...
        holder.itemList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("TRANSPORT_TYPE", "train");
